...
const schema = z.object({
  ...
  room: z
    ...
    .max(
      50,
      'Keep the room under 50 characters.',
    ),
  ...
  coverage: z
    ...
    .max(
      5000,
      'Keep coverage under 5,000 characters.',
    ),
