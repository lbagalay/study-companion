...
export function EditorialBackdrop() {
  ...
  return (
    <View style={styles.backdrop}>
      ...
      >
        <Ionicons color={palette.accent} name="heart-outline" size={18} />
      </Animated.View>
      <Animated.View
        style={[
          styles.sparkle,
          {
            opacity: drift.interpolate({ inputRange: [0, 1], outputRange: [0.35, 0.72] }),
            transform: [
      ...
      >
        <Ionicons color={palette.lavender} name="sparkles-outline" size={16} />
      </Animated.View>
