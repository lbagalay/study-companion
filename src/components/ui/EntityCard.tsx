...
const styles = StyleSheet.create({
  card: { alignItems: 'center', borderRadius: radii.lg, borderWidth: 1, boxShadow: '0 6px 18px rgba(180, 72, 78, 0.07)', flexDirection: 'row', gap: spacing.md, overflow: 'hidden', padding: 16 },
  accent: { alignSelf: 'stretch', borderRadius: radii.pill, width: 5 },
  copy: { flex: 1, gap: spacing.xs },
  title: { ...typography.sectionTitle, fontSize: 18 },
  subtitle: typography.body,
  metadata: typography.caption,
  badge: { ...typography.caption, borderRadius: radii.pill, overflow: 'hidden', paddingHorizontal: spacing.sm, paddingVertical: 6 },
});
